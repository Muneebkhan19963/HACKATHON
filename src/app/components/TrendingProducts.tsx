    ...
    <div className="w-full bg-white py-20">
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          ...
          <button className="text-indigo-950 mb-10 mr-16 underline text-lg font-medium">Shop Now</button>
          <Image
            src="/images/voucher1.png"
            alt="Voucher Image"
            width={200}
            height={200}
            className="absolute bottom-2 pl-10 right-0 object-contain"
          />
        </div>
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          <h3 className="text-[#3F509E] text-2xl font-bold mb-4">23% Off in all products</h3>
   {/* Button */}
   <button className="text-indigo-950  underline text-lg font-medium mt-4">
    View Collection
  </button>
          <Image
