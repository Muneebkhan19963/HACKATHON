  ...
  return (
    <div className="bg-gray-100 py-16 text-gray-600">
      <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {/* First Section */}
        <div>
          <h1 className="text-[#151875] text-3xl font-extrabold mb-4">FURNISHO</h1>
          <div className="flex items-center border border-gray-300 rounded-md overflow-hidden mb-4">
            ...
            <button
              ...
              className="bg-indigo-950 text-white px-4 py-2 text-sm font-medium hover:bg-indigo-600 transition-colors"
            >
              Sign Up
            </button>
          </div>
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          <p className="text-gray-500">&copy; Webecy - All Rights Reserved by MUNEEB KHAN</p>
