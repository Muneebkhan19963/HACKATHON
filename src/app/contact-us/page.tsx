      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12 flex flex-wrap gap-12">
        ...
        <div className="flex-1">
          ...
          <form className="space-y-4">
            ...
            <textarea
              ...
              className="w-full border border-gray-300 rounded-md p-3 outline-none text-sm"
            ></textarea>
            <button className="bg-indigo-950 text-white py-3 px-8 rounded-md hover:bg-indigo-800 transition-colors">
              Send Mail
            </button>
          </form>
        </div>
        ...
        <div className="flex-1">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <span className="w-3 h-3 rounded-full bg-indigo-950"></span>
              <div className="text-gray-600">
                <p>Support Forum</p>
                <p>For over 24hr</p>
              </div>
