      ...
      <div className="bg-gray-100 py-10">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-gray-200 py-3 px-6 rounded-md text-sm text-center">
            ...
            <span className="text-black mx-2">.</span>
            <span className="text-indigo-950">My Account</span>
          </div>
          ...
          <div className="bg-white mt-8 p-8 rounded-md shadow-md">
            ...
            <form>
              ...
              <div className="mb-4 text-right">
                <Link href="/forgot-password" className="text-indigo-950 hover:underline">
              ...
              <button
                type="submit"
                className="w-full bg-indigo-950 text-white py-2 rounded-md hover:bg-indigo-600 transition-colors"
              >
                Sign In
              </button>
            </form>
            ...
            <div className="text-center mt-6 text-gray-600">
              ...
              <Link href="/register" className="text-indigo-950 hover:underline">
                Create account
              </Link>
            </div>
          </div>
