    ...
    <div className="p-6 lg:p-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        ...
        <div className="flex justify-between mt-4">
          <button className="px-4 py-2 bg-indigo-950 text-white rounded-md text-xs sm:text-sm">
            Update Cart
          </button>
          <button className="px-4 py-2 bg-indigo-950 text-white rounded-md text-xs sm:text-sm">
            Clear Cart
      ...
      <div className="p-6 bg-gray-50 rounded-md shadow-md flex flex-col justify-between">
        <div>
          ...
          <button className="w-full py-2 bg-indigo-600 text-white rounded-md text-xs sm:text-sm">
            Proceed To Checkout
          </button>
        </div>
        {/* Shipping Calculator */}
        <div className="p-6 bg-gray-50 rounded-md shadow-md">
          ...
          />
          <button className="w-full py-2 bg-indigo-950 text-white rounded-md text-xs sm:text-sm">
            Calculate Shipping
          </button>
        </div>
      </div>
