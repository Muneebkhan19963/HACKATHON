...
function Discount() {
  return (
    <div className="w-full py-20">
      <div className="w-full  ml-20 max-w-screen-xl mx-auto">
        {/* Heading */}
        ...
        <div className="flex justify-center space-x-8 mb-12">
          {["Wood Chair", "Plastic Chair", "Sofa Chair"].map((tag) => (
            <button
              key={tag}
              className="relative text-lg font-medium text-gray-700 hover:text-indigo-950"
            >
              {tag}
              <span className="block h-[2px] w-0 bg-indigo-950 absolute bottom-0 left-0 transition-all duration-300 hover:w-full"></span>
              <span className="absolute -left-4 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-indigo-950 rounded-full opacity-0 hover:opacity-100"></span>
            </button>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h4 className="text-indigo-950 text-xl font-semibold mb-6">Eames Sofa Compact</h4>
          ...
          <Link href="/shoplist">
            <button className="px-6 py-2 bg-indigo-950 text-white font-text rounded-md shadow-md hover:bg-indigo-700">
              Shop Now
            </button>
          </Link>
            </div>
