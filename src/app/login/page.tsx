        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <button
                type="submit"
                className="w-full sm:w-auto px-6 py-2 bg-indigo-950 text-white font-semibold rounded-md hover:bg-black"
              >
                Log In
              </button>
              <a href="#" className="text-sm text-black hover:text-red-700 text-center">
                Forgot Password?
              </a>
            </div>
          </form>
