  ...
  return (
    <div className="relative w-full bg-[#F3F3F3] overflow-hidden flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col md:flex-row items-center justify-start pl-6 md:pl-16 relative">
        ...
        {/* Bulb Image */}
<div className="ml-10 relative pb-20 md:absolute top-[-30px] left-[-30px] md:left-[-100px]">
  <Image src="/images/bulb.png" alt="Bulb" width={300} height={300} className="object-contain" />
</div>


        {/* Text Content - Aligning next to the bulb */}
        <div className="relative mt-6 pl-14 md:mt-0 md:ml-16 text-center md:text-left">
          {/* indigo Text */}
          <p className="text-indigo-950 text-lg md:text-xl font-normal mb-2">
          ...
          {/* Shop Now Button */}
          <Link href="/shoplist">
            <button className="px-6 py-2 bg-indigo-950 text-white font-text rounded-md shadow-md hover:bg-indigo-600">
              Shop Now
            </button>
          </Link>
        </div>
